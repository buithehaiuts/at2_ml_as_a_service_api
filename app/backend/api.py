...
print(f"Absolute path of the current file: {current_file_path}")
...
#     model_files = {
#         'prophet': Path('models') / 'prophet.pkl',
#         'prophet_event': Path('models') / 'prophet_event.pkl',
#         'prophet_holiday': Path('models') / 'prophet_holiday.pkl',
#         'prophet_month': Path('models') / 'prophet_month.pkl'
#     }
